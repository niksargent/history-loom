...
- `data/shared/usa/meta.json`
- `data/shared/usa/periods.json`
- `data/shared/usa/events.json`
- `data/shared/usa/pressures.json`
- `data/shared/usa/echoes.json`
- `data/shared/usa/snapshots.json`
