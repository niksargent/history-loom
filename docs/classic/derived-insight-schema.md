...
Current files:
- `data/classic/derived/britain-1066-2025.json`
- `data/classic/derived/united-states-1776-2025.json`
- `data/classic/derived/france-1789-2025.json`
- `data/classic/derived/cross-dataset.json`

These packs are generated offline by:
- `tools/data/generate-derived-insights.mjs`
