...
- `docs/classic/dataset-editorial-review-checklist.md`
- `docs/classic/data-schema.md`
- `docs/classic/public-language-guide.md`
...
Do not add a new dataset to `data/shared/datasets.json` until:
...
1. add a new entry to `data/shared/datasets.json`
2. set:
   - `id`
   - `dataPath`
   - `label`
...
- editorial review against `docs/classic/dataset-editorial-review-checklist.md`
- validation review
- public-language review against `docs/classic/public-language-guide.md`
