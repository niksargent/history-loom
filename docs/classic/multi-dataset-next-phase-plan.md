...
Status:
- the first product brief for `In motion` now exists in `docs/classic/in-motion-brief.md`
...
- the concrete v1 Race spec now exists in `docs/classic/in-motion-race-spec.md`
...
Status:
- the planning layer exists in `docs/classic/population-extension-plan.md`
...
Status:
- the planning layer now exists in `docs/classic/data-science-insight-plan.md`
