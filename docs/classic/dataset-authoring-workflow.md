...
- `docs/classic/dataset-production-runbook.md`
...
Selection should follow the event standard in `docs/classic/dataset-authoring-standards.md`, not fame or quota alone.
