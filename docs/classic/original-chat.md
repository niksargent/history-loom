...
* `docs/classic/prd.md`
* `docs/classic/interface-concepts.md`
* `docs/classic/data-schema.md`
* `docs/classic/content-taxonomy.md`
* `docs/classic/mvp-scope.md`
* `docs/classic/design-language.md`

### C. Seed data

Add a small JSON or YAML dataset, e.g.:

* `data/shared/periods.json`
* `data/shared/pressures.json`
* `data/shared/echoes.json`
