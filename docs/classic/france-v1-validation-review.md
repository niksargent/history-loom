...
- `data/shared/france/meta.json`
- `data/shared/france/periods.json`
- `data/shared/france/events.json`
- `data/shared/france/pressures.json`
- `data/shared/france/echoes.json`
- `data/shared/france/snapshots.json`
