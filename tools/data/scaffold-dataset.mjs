...
async function loadCanonicalPressures() {
  const filePath = path.join(repoRoot, 'data/shared', 'pressures.json')
...
- \`docs/classic/${shortName}-dataset-charter.md\`
- \`docs/classic/${shortName}-periodization-proposal.md\`
- \`docs/classic/${shortName}-initial-seed-candidates.md\`
- \`docs/classic/${shortName}-pressure-grounding-map.md\`
- \`docs/classic/${shortName}-snapshot-strategy.md\`
...
async function main() {
  ...
  const datasetDir = path.join(repoRoot, 'data/shared', folder)
  const docsDir = path.join(repoRoot, 'docs/classic')
  ...
  await writeJson(
    path.join(repoRoot, 'data/classic', `${shortName}-priority-queue.json`),
    buildPriorityQueue(label),
  )

  console.log(`Scaffolded ${label}.`)
  console.log(`Dataset id: ${id}`)
  console.log(`Data folder: data/shared/${folder}`)
  console.log('Docs created:')
  console.log(`- docs/classic/${shortName}-dataset-charter.md`)
  console.log(`- docs/classic/${shortName}-periodization-proposal.md`)
  console.log(`- docs/classic/${shortName}-seeding-plan.md`)
  console.log(`- docs/classic/${shortName}-initial-seed-candidates.md`)
  console.log(`- docs/classic/${shortName}-pressure-grounding-map.md`)
  console.log(`- docs/classic/${shortName}-snapshot-strategy.md`)
  console.log(`- data/classic/${shortName}-priority-queue.json`)
  console.log('')
  console.log('Next steps:')
  console.log('1. Fill the planning docs before registering the dataset in data/shared/datasets.json.')
