...
const checks = [
  {
    file: 'apps/classic/src/components/DetailPanel.tsx',
    mustInclude: [
  ...
  {
    file: 'apps/classic/src/components/ComparePanel.tsx',
    mustInclude: [
      'getPublicPeriodSummary(',
      'getPublicEventSummary(',
      'buildCompareStory(',
  ...
  {
    file: 'apps/classic/src/lib/compare-story.ts',
    mustInclude: [
      'getPublicEchoSimilarityLabel(',
      'getPublicEchoSimilarityReasons(',
      'getPublicEchoNotes(',
  ...
  {
    file: 'apps/classic/src/components/ForceExplorer.tsx',
    mustInclude: ['getPublicEventSummary('],
    mustNotInclude: [],
  },
  {
    file: 'apps/classic/src/components/LoomCanvas.tsx',
    mustInclude: ['getPublicPeriodSummary('],
    mustNotInclude: [],
  },
  {
    file: 'apps/classic/src/lib/loom-data.ts',
    mustInclude: [
