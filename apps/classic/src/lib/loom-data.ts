import datasetsJson from '../../../../data/shared/datasets.json'
import type {
...
const metaModules = {
  ...import.meta.glob('../../../../data/shared/meta.json'),
  ...import.meta.glob('../../../../data/shared/*/meta.json'),
} as JsonModuleLoader<Meta>

const periodModules = {
  ...import.meta.glob('../../../../data/shared/periods.json'),
  ...import.meta.glob('../../../../data/shared/*/periods.json'),
} as JsonModuleLoader<Period[]>

const eventModules = {
  ...import.meta.glob('../../../../data/shared/events.json'),
  ...import.meta.glob('../../../../data/shared/*/events.json'),
} as JsonModuleLoader<Event[]>

const pressureModules = {
  ...import.meta.glob('../../../../data/shared/pressures.json'),
  ...import.meta.glob('../../../../data/shared/*/pressures.json'),
} as JsonModuleLoader<PressureSeries[]>

const echoModules = {
  ...import.meta.glob('../../../../data/shared/echoes.json'),
  ...import.meta.glob('../../../../data/shared/*/echoes.json'),
} as JsonModuleLoader<EchoLink[]>

const snapshotModules = {
  ...import.meta.glob('../../../../data/shared/snapshots.json'),
  ...import.meta.glob('../../../../data/shared/*/snapshots.json'),
} as JsonModuleLoader<HumanSnapshot[]>

function buildDatasetFilePath(dataPath: string, fileName: string): string {
  return dataPath === '.'
    ? `../../../../data/shared/${fileName}.json`
    : `../../../../data/shared/${dataPath}/${fileName}.json`
}
