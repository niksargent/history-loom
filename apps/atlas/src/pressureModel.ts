import britain from '../../../data/shared/periods.json' with { type: 'json' }
import france from '../../../data/shared/france/periods.json' with { type: 'json' }
import germany from '../../../data/shared/germany/periods.json' with { type: 'json' }
import usa from '../../../data/shared/usa/periods.json' with { type: 'json' }
