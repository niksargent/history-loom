...
import britain from '../../../data/shared/periods.json'
import france from '../../../data/shared/france/periods.json'
import germany from '../../../data/shared/germany/periods.json'
import usa from '../../../data/shared/usa/periods.json'
  ...
  return (
    <div className="fingerprint-lab">
      ...
      <details className="evidence">
        ...
        <a
          href={`${import.meta.env.BASE_URL}classic/`}
          target="_blank"
          rel="noreferrer"
        >
