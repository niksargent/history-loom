...
import { ExperienceSwitch } from '../../shared/ExperienceSwitch'
  ...
  return (
    <div className="atlas-app">
      ...
      <header className="site-header">
        <div className="atlas-brand-group">
        <button
          className="brand"
        ...
        <ExperienceSwitch current="atlas" />
        </div>
      ...
      <footer className="site-footer">
        ...
        <div>
          ...
          <a href={`${import.meta.env.BASE_URL}classic/`}>
